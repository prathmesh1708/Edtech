...
import StudentLayout from './views/components/layout/StudentLayout';
...
// Student Pages
const StudentDashboard = lazy(() => import('./views/pages/student/Dashboard/Dashboard'));
...
// Admin Pages
const AdminDashboard = lazy(() => import('./views/pages/admin/AdminDashboard/AdminDashboard'));
const StudentManagement = lazy(() => import('./views/pages/admin/StudentManagement/StudentManagement'));
const SyllabusManagement = lazy(() => import('./views/pages/admin/SyllabusManagement/SyllabusManagement'));
const ContentManagement = lazy(() => import('./views/pages/admin/ContentManagement/ContentManagement'));
const PlatformSettings = lazy(() => import('./views/pages/admin/PlatformSettings/PlatformSettings'));
