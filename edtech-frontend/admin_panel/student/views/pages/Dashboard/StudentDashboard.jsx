            ...
            {subjects.map((subj) => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)' }}>
                  <div style={{ width: '44px', height: '44px', borderRadius: 'var(--radius-lg)', background: `${subj.color || '#4F6EF7'}14`, color: subj.color || '#4F6EF7', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <BookOpen size={20} />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <div style={s.progressBar}>
                    <div style={{ width: `${subj.progress}%`, height: '100%', background: subj.color || '#4F6EF7', borderRadius: 'var(--radius-full)' }} />
                  </div>
                </div>
